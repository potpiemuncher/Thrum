...
namespace DS4WinWPF.DS4Forms.ViewModels
{
    public class LogViewModel
    {
        ...
        public LogViewModel(DS4Windows.ControlService service)
        {
            ...
            logItems.Add(new LogItem { Datetime = DateTime.Now, Message = $"{DS4Windows.ProductInfo.ProductName} version {version}" });
            logItems.Add(new LogItem { Datetime = DateTime.Now, Message = $"{DS4Windows.ProductInfo.ProductName} Assembly Architecture: {(Environment.Is64BitProcess ? "x64" : "x86")}" });
