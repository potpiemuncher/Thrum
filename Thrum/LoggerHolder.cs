...
namespace DS4WinWPF
{
    public class LoggerHolder
    {
        ...
        public LoggerHolder(DS4Windows.ControlService service)
        {
            ...
            fileTarget.FileName = $@"{DS4Windows.Global.appdatapath}\Logs\{DS4Windows.ProductInfo.LogFileName}";
            fileTarget.ArchiveFileName = $@"{DS4Windows.Global.appdatapath}\Logs\{DS4Windows.ProductInfo.LogArchiveFileName}";
