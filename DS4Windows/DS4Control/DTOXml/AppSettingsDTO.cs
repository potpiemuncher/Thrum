...
namespace DS4WinWPF.DS4Control.DTOXml
{
    ...
    public class AppSettingsDTO : IDTO<BackingStore>
    {
        ...
        // Allow-list of profile names the two-finger swipe may switch between.
        // Serializes as <SwipeProfileList><Profile>name</Profile>...</SwipeProfileList>.
        [XmlArray("SwipeProfileList")]
        [XmlArrayItem("Profile")]
        public List<string> SwipeProfileList
        {
            get; set;
        } = new List<string>();
        ...
        public void MapFrom(BackingStore source)
        {
            ...
            SwipeProfileList = source.swipeProfileList != null
                ? new List<string>(source.swipeProfileList)
                : new List<string>();
        ...
        public void MapTo(BackingStore destination)
        {
            ...
            destination.swipeProfileList = SwipeProfileList != null
                ? new List<string>(SwipeProfileList)
                : new List<string>();
