...
- [ ] C13 DualSense on Bluetooth: plug it into a wall charger (not the PC). The controller card says "Charging" and the battery reads with a "+"; unplug it and it says "On battery". Plugged into the PC by USB it still says "Charging".
